...
class encoder_block(nn.Module):
    def __init__(self, inCh, dropout_rate=0.2, debug=False):
        ...
        self.encoder = nn.Sequential(
            ...
            ConvBlock3D(nf[0], nf[0], [k_t, 1, 1], [1, 1, 1], [pad_t, 0, 0]),
            ConvBlock3D(nf[0], nf[1], [3, 3, 3], [1, 2, 2], [1, 1, 1]),
            nn.Dropout3d(p=dropout_rate),

            ConvBlock3D(nf[1], nf[1], [k_t, 1, 1], [1, 1, 1], [pad_t, 0, 0]),
            ConvBlock3D(nf[1], nf[2], [3, 3, 3], [2, 2, 2], [1, 1, 1]),
            nn.Dropout3d(p=dropout_rate),

            ConvBlock3D(nf[2], nf[2], [k_t, 1, 1], [1, 1, 1], [pad_t, 0, 0]),
            ConvBlock3D(nf[2], nf[3], [3, 3, 3], [2, 2, 2], [1, 1, 1]),
            nn.Dropout3d(p=dropout_rate),
