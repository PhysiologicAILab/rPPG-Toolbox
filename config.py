...
_C.MODEL.iBVPNet.MD_FSAM = True
_C.MODEL.iBVPNet.MD_TYPE = 'NMF'
...
def update_config(config, args):
    ...
    if config.TOOLBOX_MODE == 'train_and_test' or config.TOOLBOX_MODE == 'only_test':
        ...
        config.TEST.OUTPUT_SAVE_DIR = os.path.join(config.LOG.PATH, config.VALID.DATA.EXP_DATA_NAME, 'saved_test_outputs')
        ...
        raise ValueError(
            'TOOLBOX_MODE only supports only_train, train_and_test, only_test, or unsupervised_method!')
